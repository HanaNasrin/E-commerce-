...
// // // // const AdminNavbar = () => {
// // // //     return(
// // // //     <nav className="bg-blue-300 text-gray-900 shadow-lg">
...
//   }
//   return (
//     <nav className="bg-gray-500 text-white shadow-xl sticky z-50 top-0">
//       <div className="container mx-auto flex items-center justify-between py-4 px-6">
//         {/* Logo Section */}
//         <div className="flex items-center space-x-2">
//           <img
//             src="https://cdn-icons-png.flaticon.com/128/898/898546.png"
//             alt="logo"
//             className="w-14 h-14"
//           />
//           <p className="font-extrabold text-2xl">E-commerce</p>
//         </div>
...
//         {/* Desktop Logout Button */}
//         <div className="hidden md:flex items-center">
//           <img src="https://th.bing.com/th/id/OIP.IljixC_8kr6tps-BhycIzwHaHa?pid=ImgDet&w=189&h=189&c=7" alt="icon" className="w-8 h-8" />
//           <button
//             className="p-2 text-lg font-medium rounded-md hover:bg-gray-700 transition duration-300"
//             onClick={handleLogout}
//           >
    ...
    <nav className="bg-gray-700 text-white shadow-xl sticky z-50 top-0">
      <div className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <div className="hidden md:flex space-x-6">
          <Link
            to="/admin"
            className="px-4 py-2 text-lg font-medium rounded-md hover:bg-gray-600 transition duration-300"
          >
            Dashboard
          </Link>
          <Link
        ...
        {/* Desktop Logout Button */}
        <div className="hidden md:flex items-center">
          <img src="https://th.bing.com/th/id/OIP.IljixC_8kr6tps-BhycIzwHaHa?pid=ImgDet&w=189&h=189&c=7" alt="icon" className="w-6 h-6" />
          <button
            className="p-2 text-lg font-medium rounded-md hover:bg-gray-700 transition duration-300"
            onClick={handleLogout}
          >
